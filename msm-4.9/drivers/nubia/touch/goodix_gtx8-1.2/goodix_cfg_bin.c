...
#ifdef CONFIG_FB
	core_data->fb_notifier.notifier_call = goodix_ts_fb_switch_notifier_callback;
	if (msm_drm_switch_register_client(&core_data->fb_notifier) < 0) {
